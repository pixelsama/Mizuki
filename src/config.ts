...
export const siteConfig: SiteConfig = {
	...
	font: {
		...
		resourceHanRoundedCNBold: {
			enable: true, // 启用 ResourceHanRoundedCN-Bold 字体作为全局字体
		},
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/pixelsama",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/514784944",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	name: "Pixelsama",
	bio: "Is completely immersing oneself in illusion a form of release?",
	links: [
		{
			name: "Bilibli",
			icon: "fa6-brands:bilibili",
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to pixelsama Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
